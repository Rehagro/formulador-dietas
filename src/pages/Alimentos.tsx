...
const GRUPOS: GrupoCols[] = [
  ...
  { label: 'Energia', cols: [
    ...
    { label: 'DE base',  render: a => a.de_base !== null && a.de_base !== undefined ? num(a.de_base, 2) : '—' },
  ...
  { label: 'Fibra', cols: [
    ...
    { label: 'Lignina %', render: a => a.lignin !== null && a.lignin !== undefined ? pct1(a.lignin) : '—' },
  ]},
  { label: 'Gordura', cols: [
