...
function Metric({ icon, label, value, unit, colorClass, ringClass }: {
  icon: string; label: string; value: string; unit?: string;
  colorClass: string; ringClass?: string;
}) {
  return (
...
export default function ResumoDieta({ resultado, leite, precoLeite }: Props) {
